...
bincountfile <- file.path(datadir,"272torts_snp1e6_minmapq20minq30_map2kenro.counts.maxAlleleCount20.bin")
...
This uses correlations of site coverages with whole-genome PC scores, as output by [this script](../count-utils/get-pc-counts.R):
```
for k in 1 2
do
    Rscript  ../count-utils/get-pc-counts.R 272torts/272torts_snp1e6_minmapq20minq30_map2kenro.counts.maxAlleleCount20.bin $k &
done
```
...
get_pc_cors <- function (pc.num){
    ...
    pccountfile <- paste0(bincountfile,countsuffix)
...
list_to_mdlist( paste0('[', superlong, '](', superlong, '_maps/high_cor/index.html', ')') )
```
