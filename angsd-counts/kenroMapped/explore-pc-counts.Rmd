...
```{r pc_count_connection, include=FALSE}
pc.num <- 1
...
```{r cor_vs_freq, fig.width=2*fig.dim}
layout(t(1:2))
...
```{r na_cor_vs_freq, fig.width=2*fig.dim}
...
```{r high_cor_maps_2, include=FALSE}
pc.num <- 2
