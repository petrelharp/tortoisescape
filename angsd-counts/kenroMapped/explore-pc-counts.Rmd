...
list_to_mdlist( paste0('[', superlong, '](', c(superlong,outliers), '_maps/high_cor/index.html', ')') )
```
Scaffolds with many high-correlation SNPs:
```{r map_scafs_list_outliers, results="asis", echo=FALSE}
list_to_mdlist( paste0('[', outliers, '](', c(superlong,outliers), '_maps/high_cor/index.html', ')') )
```
