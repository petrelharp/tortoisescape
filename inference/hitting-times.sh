...
Rscript make-resistance-distances.R ../geolayers/multigrid/${RES}/crm_ ${RES} $LAYERFILE $PARAMFILE analytic
...
do
    ...
    Rscript disaggregate-ht.R ../geolayers/multigrid/${RES}/crm_ ../geolayers/multigrid/${NEXTRES}/crm_ ${RES} ${NEXTRES} ${LAYERFILE} ${RES}/${LAYERFILE}-hitting-times.tsv 2

    echo "----------------------------"
    echo "Hitting times at ${NEXTRES}."
    Rscript make-resistance-distances.R ../geolayers/multigrid/${NEXTRES}/crm_ ${NEXTRES} $LAYERFILE $PARAMFILE numeric ${NEXTRES}/${RES}-${LAYERFILE}-aggregated-hitting-times.tsv 100
