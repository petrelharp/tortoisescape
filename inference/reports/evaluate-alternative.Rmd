...
# plotting whatnot
ph <- plot.ht.fn(nonmissing=nonmissing,layer=nalayer,sample.loc.file=config$sample_locs)
# reference points
ref.pt.obj  <- load(file.path(base.dir,"geolayers/reference_points/all_ref_points.RData"))
...
chunk.clumped <- clump( mask(nalayer,alt,inverse=TRUE) )
...
alt.hts <- hitting.analytic(ref.neighborhoods[plot.points],G,blocked=all.chunks )
