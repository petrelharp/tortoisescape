...
opts_chunk$set(cache.path=paste("cache/",alt.file,"_",summary.dir,"_",sep=""))
opts_chunk$set(fig.path=paste("figure/",alt.file,"_",summary.dir,"_",sep=""))
```
...
for (k in seq_along(chunk.info.list)) {
    with( list2env( chunk.info.list[[k]] ), {
            pos.diffmat <- pmax(0,sub.alt.hts-sub.hts)
