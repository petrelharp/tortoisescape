...
pi.fac <- (( 56575857 / 1898838430 ) / 2.01e-9)/(.018 * 1e8) / 2
```
...
rel.tdiffs <- ( rowSums( ( (sym((alt.hts-hts)[ref.locs,]) * nearby) / (sym(hts)) )[alt.good.refs,], na.rm=TRUE ) / rowSums(nearby[alt.good.refs,]) )
diff.cols <- diverge_hcl(128, h=c(225,0), c=100, l=c(60,95), power=0.65)
