...
all remaining mean 15km-commute times were smaller than $10^6$ years
(the maximum observed divergence between any pair of samples was around $3 \times 10^5$,
so distance of order $10^6$ would be equivalent to a separation of three times the width of the current range).
