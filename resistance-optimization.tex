...
Then
\begin{align}
  \partial_{\gamma_k} F(\gamma,\delta) &= 
    2 \sum_{i=1}^m \sum_{z \neq y_i} 
...
and
\begin{align}
  \partial_{\delta_k} F(\gamma,\delta) &= 
    2 \sum_{i=1}^m \sum_{z \neq y_i} 
...
so that
\begin{align}
  \partial_{\gamma_k} F(\gamma,\delta) &= 2 \sum_{i=1}^m \sum_{z \neq y_i} \left( L^k_z (1-\rho(\gamma L_z)) G_{zx} H_{xy_i}\right) \left( \sum_x G_{zx} H_{xy_i} + 1 \right)  
\end{align}
and
\begin{align}
