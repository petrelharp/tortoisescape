...
count.list <- parallel::mclapply( ((0:9)*10)/100, function (pmin) {
        system( paste("../count-utils/get-random-site.sh",
                      "../../angsd-counts/272torts_snp1e6_minmapq20minq30.mafs.gz",
                      "../../angsd-counts/272torts_snp1e6_minmapq20minq30.counts.gz",
                      pmin, pmin+0.1, 100), intern=TRUE )
    }, mc.cores=8 )
```
...
counts.header <- scan("../../angsd-counts/272torts_snp1e6_minmapq20minq30.counts.gz",nlines=1,what="char")
counts <- scan("../../angsd-counts/272torts_snp1e6_minmapq20minq30.counts.gz",skip=1)
colnames(counts) <- counts.header
