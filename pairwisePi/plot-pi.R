...
pdf(file="coverage-library-concentration.pdf",width=12,height=4)
layout(t(1:3))
...
plot( torts$Final.library.concentration..nM., rowMeans(pimats[["unbiased10"]]), type='n' )
text( torts$Final.library.concentration..nM., rowMeans(pimats[['unbiased10']]), labels=torts$EM_Tort_ID, col=1+torts$EM_Tort_ID%in%lowcoverage+2*torts$EM_Tort_ID%in%weirdos )
plot(elev)
